let Signup,bcrypt,nodemailer,multer;_40c‍.x([["default",()=>_40c‍.o]]);_40c‍.w("../model/Signup",[["default",["Signup"],function(v){Signup=v}]]);_40c‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_40c‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_40c‍.w("multer",[["default",["multer"],function(v){multer=v}]]);
...
const helpController = {
        ...
        return res
          .status(400).json({ msg: "An account with this email already exists." });
            ...
            const passwordHash = await bcrypt.hash(password, salt);
              _40c‍.g.console.log(passwordHash);
  ...
  async login(req, res) {
    ...
    async resetpassword(req,res) {
        ...
        _40c‍.g.console.log("check",req.query.token)
 
     let user =  await Signup.findOne({token: req.query.token});
        _40c‍.g.console.log(user);
