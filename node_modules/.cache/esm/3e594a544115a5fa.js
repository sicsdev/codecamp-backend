let Signup,bcrypt,nodemailer,multer;_411‍.x([["default",()=>_411‍.o]]);_411‍.w("../model/Signup",[["default",["Signup"],function(v){Signup=v}]]);_411‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_411‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_411‍.w("multer",[["default",["multer"],function(v){multer=v}]]);
...
const userController = {
        ...
        return res
          .status(400).json({ msg: "An account with this email already exists." });
            ...
            const passwordHash = await bcrypt.hash(password, salt);
              _411‍.g.console.log(passwordHash);
  ...
  async login(req, res) {
    ...
    async resetpassword(req,res) {
        ...
        _411‍.g.console.log("check",req.query.token)
 
     let user =  await Signup.findOne({token: req.query.token});
        _411‍.g.console.log(user);
