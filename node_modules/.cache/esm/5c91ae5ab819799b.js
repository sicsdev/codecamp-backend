let Signup,bcrypt,nodemailer,multer;_b81‍.x([["default",()=>_b81‍.o]]);_b81‍.w("../model/Signup",[["default",["Signup"],function(v){Signup=v}]]);_b81‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_b81‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_b81‍.w("multer",[["default",["multer"],function(v){multer=v}]]);
...
const helpController = {
        ...
        return res
          .status(400).json({ msg: "An account with this email already exists." });
            ...
            const passwordHash = await bcrypt.hash(password, salt);
              _b81‍.g.console.log(passwordHash);
  ...
  async login(req, res) {
    ...
    async resetpassword(req,res) {
        ...
        _b81‍.g.console.log("check",req.query.token)
 
     let user =  await Signup.findOne({token: req.query.token});
        _b81‍.g.console.log(user);
