let Signup,bcrypt,nodemailer,multer;_4c7‍.x([["default",()=>_4c7‍.o]]);_4c7‍.w("../model/Signup",[["default",["Signup"],function(v){Signup=v}]]);_4c7‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_4c7‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_4c7‍.w("multer",[["default",["multer"],function(v){multer=v}]]);
...
const helpController = {
        ...
        return res
          .status(400).json({ msg: "An account with this email already exists." });
            ...
            const passwordHash = await bcrypt.hash(password, salt);
              _4c7‍.g.console.log(passwordHash);
  ...
  async login(req, res) {
    ...
    async resetpassword(req,res) {
        ...
        _4c7‍.g.console.log("check",req.query.token)
 
     let user =  await Signup.findOne({token: req.query.token});
        _4c7‍.g.console.log(user);
