let Signup,bcrypt,nodemailer,multer;_968‍.x([["default",()=>_968‍.o]]);_968‍.w("../model/Signup",[["default",["Signup"],function(v){Signup=v}]]);_968‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_968‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_968‍.w("multer",[["default",["multer"],function(v){multer=v}]]);
...
const userController = {
        ...
        return res
          .status(400).json({ msg: "An account with this email already exists." });
            ...
            const passwordHash = await bcrypt.hash(password, salt);
              _968‍.g.console.log(passwordHash);
  ...
  async login(req, res) {
    ...
    async resetpassword(req,res) {
        ...
        _968‍.g.console.log("check",req.query.token)
 
     let user =  await Signup.findOne({token: req.query.token});
        _968‍.g.console.log(user);
